...
android {
    namespace = "com.example.geminifunctioncall"
    compileSdk = 36
    defaultConfig {
        applicationId = "com.example.geminifunctioncall"
        minSdk = 35
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
    ...
    kotlinOptions {
        jvmTarget = "17"
        freeCompilerArgs += "-opt-in=com.google.firebase.ai.type.PublicPreviewAPI"
    }
}
dependencies {
